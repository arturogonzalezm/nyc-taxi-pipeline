...
class TestZoneLookupIngestionJobGetMinioClient:
    ...
    def test_get_minio_client_success(self):
        ...
        with patch(
            "etl.jobs.bronze.zone_lookup_ingestion_job.Minio", return_value=mock_client
        ):
    ...
    def test_get_minio_client_failure(self):
        ...
        with patch(
            "etl.jobs.bronze.zone_lookup_ingestion_job.Minio",
...
class TestZoneLookupIngestionJobExtract:
    ...
    def test_extract_calls_extract_from_source(self):
        ...
        with patch.object(
            job, "_extract_from_source", return_value=mock_df
        ) as mock_extract:
            result = job.extract()
